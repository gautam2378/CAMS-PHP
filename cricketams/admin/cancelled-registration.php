...
<head>
  ...
  <title>Cricket Academy Management System | Approved Registration</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cancelled Registration</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Cancelled Registration</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
             ...
             <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
$sql="SELECT tbluser.ID, tbluser.FullName,tbluser.UserName,tbluser.MobileNumber,tbluser.Email,tblregistration.ID as rid,tblregistration.UserID,tblregistration.RegistrationNumber,tblregistration.PlayerName,tblregistration.Status from tblregistration join tbluser on tbluser.ID=tblregistration.UserID where tblregistration.Status='Cancelled'";
