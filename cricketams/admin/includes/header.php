...
$cnt=1;
$newreg=$query->rowCount();
?>
        <a class="nav-link" data-toggle="dropdown" href="#">
          <i class="far fa-bell"></i>
          <span class="badge badge-warning navbar-badge"><?php echo $newreg;?></span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header"><?php echo $newreg;?> New Registration</span>
          <div class="dropdown-divider"></div>
...
{ 
  ...
  ?>
          <a href="new-registration.php" class="dropdown-item">
            <i class="fas fa-users mr-2"></i> <?php echo $row->RegistrationNumber;?>
            <span class="float-right text-muted text-sm">(<?php echo $row->RegistrationDate;?>)</span>
          </a>
            <?php  } ?>
          <div class="dropdown-divider"></div>
         
          <div class="dropdown-divider"></div>
          <a href="new-registration.php" class="dropdown-item dropdown-footer">See New Notifications</a>
        </div>
      </li>
