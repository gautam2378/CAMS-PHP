...
<head>
  ...
  <title>Cricket Academy Management System |Unread Enquiry</title>
                  ...
                  <tr>
                     <td class="text-center"><?php echo htmlentities($cnt);?></td>
                                        ...
                                        <td>
                                         ...
                                         <td><a href="view-enquiry.php?viewid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary">View Details</a></td>
                  </tr>
                  </tbody><?php $cnt=$cnt+1;}} ?> 
                  <tfoot>
                  <tr>
